---
id: awareness-action-plan
title: Awareness Action Plan
description: 90-day awareness campaign plan for Iris Protocol launch and credibility building.
sidebar_position: 2
---
...
```mermaid
flowchart LR
  subgraph wave1 [Wave 1 Pre-Launch Weeks 1-4]
    W1A[Teaser Content]
    W1B[Audit Trail]
    W1C[Docs Site Live]
  end
  subgraph wave2 [Wave 2 Launch Weeks 5-8]
    W2A[Mainnet Announcement]
    W2B[KOL Affiliate Push]
    W2C[Integration PR]
  end
  subgraph wave3 [Wave 3 Sustain Weeks 9-12]
    W3A[Trader Education]
    W3B[Governance Launch]
    W3C[MirrorStation Teaser]
  end
  wave1 --> wave2 --> wave3
```
